...
def submit(request):
    if request.method == "POST":
        ...
        if request.POST.get('link'):
            ...
            listtable.link = "https://us.123rf.com/450wm/pavelstasevich/pavelstasevich1811/pavelstasevich181101027/112815900-stock-vector-no-image-available-icon-flat-vector.jpg?ver=6"
        listtable.time = dt
        listtable.save()
        all = Alllisting()
        items = Listing.objects.all()
